...
static ngx_command_t  ngx_rtmp_core_commands[] = {
    ...
    { ngx_string("buflen_force"),
      NGX_RTMP_MAIN_CONF|NGX_RTMP_SRV_CONF|NGX_CONF_TAKE1,
      ngx_conf_set_flag_slot,
      NGX_RTMP_SRV_CONF_OFFSET,
      offsetof(ngx_rtmp_core_srv_conf_t, buflen_force),
      NULL },
    ...
    { ngx_string("srv_name"),
      ...
      NGX_RTMP_SRV_CONF_OFFSET,
      offsetof(ngx_rtmp_core_srv_conf_t, srv_name),
      NULL },
...
ngx_rtmp_core_create_srv_conf(ngx_conf_t *cf)
{
    ...
    conf->buflen_force = NGX_CONF_UNSET;
...
ngx_rtmp_core_merge_srv_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    ngx_conf_merge_value(conf->buflen_force, prev->buflen_force, 0);
    ngx_conf_merge_str_value(conf->srv_name, prev->srv_name, "NGINX RTMP (github.com/sergey-dryabzhinsky/nginx-rtmp-module)");
